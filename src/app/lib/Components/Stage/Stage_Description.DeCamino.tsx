...
export const Stage_Description_DeCamino = () => {
  ...
  return (
    <article className="grid w-full h-full grid-cols-6 gap-2">
            <div className="col-span-2 border-r-3 border-DC_woodLogo rounded-r-2xl overflow-hidden overflow-y-scroll scrollbar-hide">
                ...
                <div className="text-black bg-gradient-to-br from-DC_softWood via-DC_Celeste to-DC_Celeste/30 rounded-t-3xl mt-[-48px] w-full h-auto pr-4 pb-2 pt-[56px]">
                    ...
                    <p className="pl-4 font-semibold py-2">DeCamino es una aplicación web mobile first que busca fomentar el
                    ...
                    <p className="pl-4 font-semibold py-2">Muchos pueblos rurales del interior están enfrentando un declive debido a la falta de
                    ...
                    <p className="pl-4 font-semibold py-2">DeCamino busca revitalizar estos pueblos promoviendo su oferta gastronómica casera y
            ...
            <div className="col-span-4 flex flex-col justify-center items-center overflow-hidden gap-2 py-4 pr-4">
              ...
              <div className="w-full h-full px-4 pb-4 flex items-center justify-center">
